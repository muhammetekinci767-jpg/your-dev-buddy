      ...
      <main className="flex-1 w-full flex flex-col gap-[2px]">
        ...
        <div className="relative w-full h-[85vh] md:h-[95vh] bg-gray-100 overflow-hidden">
          ...
          <div className="absolute bottom-8 right-8 text-white">
            <Link to="/womenswear" className="text-sm tracking-widest uppercase font-medium hover:opacity-70 transition-opacity drop-shadow-md underline underline-offset-4">
              Shop Collection
            </Link>
          </div>
        </div>
